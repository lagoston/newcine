...
-- Create new sync_customer_subscription_status function with jsonb return type
...
-- Fix process_stripe_webhook_event function to properly handle checkout.session.completed
