  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'bttf-banner-bolt':      { '0%': { left: '10%', opacity: '1' }, '25%': { left: '65%', opacity: '0.4' }, '50%': { left: '35%', opacity: '1' }, '75%': { left: '80%', opacity: '0.3' }, '100%': { left: '10%', opacity: '1' } },
      ...
      animation: {
        ...
        'bttf-banner-bolt':      'bttf-banner-bolt 0.8s ease-in-out infinite',
