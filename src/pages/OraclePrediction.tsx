...
export default function OraclePrediction() {
 ...
 <div className="fixed inset-0 bg-gradient-to-br from-gray-50 via-violet-50/30 to-purple-50/30 dark:from-gray-900 dark:via-violet-900/10 dark:to-purple-900/10"></div>
