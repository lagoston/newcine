...
export default function PremiumSuccess() {
 ...
 <div className="fixed inset-0 bg-gradient-to-br from-gray-50 via-yellow-50/30 to-orange-50/30 dark:from-gray-900 dark:via-yellow-900/10 dark:to-orange-900/10"></div>
