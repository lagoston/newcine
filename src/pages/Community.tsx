...
export default function Community() {
 ...
 <h2 className={`text-lg font-bold truncate ${getTextEffectNameClass(profile.text_effect, profile.is_premium ?? profile.plan_type === 'premium', profile.real_review_count || 0)}`}>
 @{profile.username}
 </h2>
 ...
 <p className={`text-sm line-clamp-2 mb-4 flex-1 ${getTextEffectSecondaryClass(profile.text_effect, profile.is_premium ?? profile.plan_type === 'premium', profile.real_review_count || 0)}`}>
