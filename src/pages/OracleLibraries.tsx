  ...
  return (
    <div className="min-h-screen pt-20 pb-24 px-4 relative overflow-hidden">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="fixed inset-0 bg-gradient-to-br from-gray-50 via-amber-50/30 to-purple-50/30 dark:from-gray-900 dark:via-amber-900/10 dark:to-purple-900/10"></div>
