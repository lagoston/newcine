...
export default function OracleDuel() {
 ...
 <div className="fixed inset-0 bg-gradient-to-br from-gray-50 via-pink-50/30 to-purple-50/30 dark:from-gray-900 dark:via-pink-900/10 dark:to-purple-900/10"></div>
