...
export default function Library() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Background unificado — gradiente + orbes decorativos numa única
          camada fixed, evitando que apareçam como duas superfícies
          distintas ao rolar/puxar além dos limites normais da tela. */}
