export const banners = {
  ...
  className: [
    ...
    // brilho externo + moldura interna + escurecimento CRT nas bordas
    'shadow-[0_0_30px_rgba(34,197,94,0.5),0_0_60px_rgba(34,197,94,0.12),inset_0_0_0_1px_rgba(34,197,94,0.25),inset_0_0_45px_rgba(0,0,0,0.75)]',
    // cor de fundo + vinheta radial (verde no topo, escuro nas bordas)
    'bg-[#000e00]',
    '[background-image:radial-gradient(130%_130%_at_50%_-10%,rgba(34,197,94,0.12),transparent_60%),radial-gradient(120%_120%_at_50%_50%,transparent_52%,rgba(0,0,0,0.6))]',
    // flicker sutil de tela de tubo
    'animate-[matrix-banner-flicker_5s_steps(1,end)_infinite]',

    // --- CHUVA DIGITAL (before) ---
    'before:absolute before:inset-0 before:pointer-events-none before:opacity-70',
    // camada 1: traços verticais que caem (topo mais claro = "cabeça" da gota)
    // camada 2: tinta por coluna (fica parada) para dar a sensação de colunas
    'before:bg-[repeating-linear-gradient(0deg,rgba(210,255,210,0.9)_0px,rgba(74,222,128,0.75)_2px,rgba(34,197,94,0.25)_4px,transparent_8px,transparent_14px),repeating-linear-gradient(90deg,rgba(34,197,94,0.16)_0px,rgba(34,197,94,0.16)_9px,transparent_9px,transparent_11px)]',
    'before:[background-size:100%_140px,100%_100%]',
    // desvanece topo e base como o matrix rain clássico
    'before:[mask-image:linear-gradient(180deg,transparent,black_12%,black_88%,transparent)]',
    'before:[-webkit-mask-image:linear-gradient(180deg,transparent,black_12%,black_88%,transparent)]',
    'before:animate-[matrix-banner-rain_1.1s_linear_infinite]',

    // --- CAMADA CRT (after): scanlines fixas + feixe que varre ---
    'after:absolute after:inset-0 after:pointer-events-none',
    // camada 1: feixe claro (varre) | camada 2: scanlines horizontais (fixas)
    'after:bg-[linear-gradient(180deg,transparent_0%,rgba(200,255,200,0.18)_40%,rgba(220,255,220,0.45)_50%,rgba(200,255,200,0.18)_60%,transparent_100%),repeating-linear-gradient(0deg,rgba(0,0,0,0.32)_0px,rgba(0,0,0,0.32)_1px,transparent_1px,transparent_3px)]',
    'after:[background-size:100%_45%,100%_3px]',
    'after:[background-repeat:no-repeat,repeat]',
    'after:animate-[matrix-banner-scan_3s_linear_infinite]',
  ].join(' '),
},
  saw: {
    id: 'saw',
